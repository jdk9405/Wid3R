...
def load_images_as_tensor_dk(path='data/truck', interval=1, PIXEL_LIMIT=255000, TARGET_W=224, TARGET_H=224):
    """
...
def load_images_as_tensor_adil(path='data/truck', interval=1, PIXEL_LIMIT=255000, TARGET_W=224, TARGET_H=224, temp_dict=None, filename_dict=None):
    """
    Loads images from a directory or video, resizes them to a uniform size,
    then converts and stacks them into a single [N, 3, H, W] PyTorch tensor.
    """
