...
class TartanAirV2(BaseDataset):
    ...
    def __init__(self,
        ...
        self.dataset_label = "TartanAirV2"
        ...
        print(f"{status}: TartanAirV2 Data Size: {self.sequence_list_len}")
        print(f"{status}: TartanAirV2 Data dataset length: {len(self)}")
    ...
    def _get_views(self, index, resolution, rng, is_flip=False):
        ...
        for anno in annos:
            ...
            depth_map = depth_rgba_float32(depth_map)
...
if __name__ == "__main__":
    ...
    frame_num = cfg.train_dataset.TartanAirV2.frame_num

    dataset = TartanAirV2(
        data_root="/fs/gamma-projects/FFD3D/dongki/data/tartanair-v2",
        mode="train",
        # mode="test",
        min_num_frames=24,
        resolution=[518, 336],
    ...
    while True:
        ...
        for seq_i in range(len(dataset)):
            ...
            aa = dataset._get_views(seq_i, [300, 150], dataset._rng, is_flip)
