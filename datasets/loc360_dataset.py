...
class Loc360(BaseDataset):
    ...
    def __init__(self,
        ...
        print(f"{status}: Loc360 Data Size: {self.sequence_list_len}")
        print(f"{status}: Loc360 Data dataset length: {len(self)}")
...
if __name__ == "__main__":
    ...
    frame_num = cfg.train_dataset.Loc360.frame_num

    dataset = Loc360(
        data_root="/fs/gamma-projects/ARL3D/dongki/data/Loc360/",
        mode="train",
        # mode="test",
        min_num_frames=24,
        resolution=[518, 336],
